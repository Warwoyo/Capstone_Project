...
@props(['mode' => 'view', 'observationList' , 'class'])
...
<div x-data="{ mode: 'view' }" class="flex-1 w-full">
<!-- View Data -->
<div x-show="mode === 'view'"class="flex-1 w-full">
<div class="overflow-y-auto hide-scrollbar max-h-[43vh] md:max-h-[72vh]">
<div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-2 items-start">
    @foreach ($observationList as $observation)
        ...
        >
          <div class="flex flex-col gap-1 overflow-hidden" @click="mode = 'add-score'">
...
<div x-show="mode === 'add-score'" class="flex-1 w-full">
    ...
    <div class="overflow-y-auto hide-scrollbar max-h-[43vh] md:max-h-[62vh] px-2">
