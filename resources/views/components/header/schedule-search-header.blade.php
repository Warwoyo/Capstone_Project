<div class="flex gap-5 items-center flex-nowrap w-full">
  ...
  <!-- Add Class Button -->
 <button class="w-1/4 sm:w-auto flex justify-center items-center gap-2 bg-sky-600 rounded-3xl border border-sky-600 h-auto sm:h-[36px] px-6 whitespace-nowrap">
    <!-- Icon Plus -->
    ...
    <span class="leading-tight text-sm sm:text-base">
        ...
        <span class="text-white block sm:inline">Jadwal</span>
    </span>
</button>