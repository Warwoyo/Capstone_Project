<!-- Search Bar -->
  <div class="flex items-center px-4 py-0 bg-white rounded-3xl border border-none h-[36px] flex-grow">
    <div>
    ...
    <div class="text-base text-sky-600 bg-transparent border-none outline-none ml-2 w-full"></div>
  </div>
